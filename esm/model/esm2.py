    ...
    def mh_sampling(self, tokens, repr_layers=[], need_head_weights=False, return_contacts=False):
        ...
        for e in range(100):
            ...
            for _i in tqdm(rand_idx):
                ...
                log_file.write("AT Position " + str(_i.cpu().numpy()) + ": ")
                log_file.write(str(w_0.cpu().numpy()) + "->" + str(w_n.cpu().numpy()) + ' ')
                log_file.write("Acceptance: " + str(accept_cond.cpu().numpy()) + '\n')
                # print("AT Position " + str(_i.cpu().numpy()) + ":", end=' ')
                # print(str(w_0.cpu().numpy()) + "->" + str(w_n.cpu().numpy()) )
